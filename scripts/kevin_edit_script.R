...
setwd("~/HotDam/input/SW_T_Dam")
output <- "~/HotDam/input/Dam_thermal_regimes_edit"
files <- dir(path = ".", pattern = "*.csv")

Main.df <- read.csv('~/HotDam/NWIS_NID_NOAA_clean.csv')
Constr_Yr <- Main.df$YEAR_COMPL
Main.df$YEAR_MODIF
